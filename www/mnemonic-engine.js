...
"alien","all","alley","allow","almost","alone","along","already","also","alter",
"always","amateur","amazing","among","amount","amused","analyst","anchor","ancient","anger",
"angle","angry","animal","ankle","announce","annual","another","answer","antenna","antique",
"anxiety","any","apart","apology","appear","apple","approve","april","arch","arctic",
"area","arena","argue","arm","armed","armor","army","around","arrange","arrest",
"arrive","arrow","art","artifact","artist","artwork","aside","ask","aspect","assault",
"asset","assist","assume","asthma","athlete","atmosphere","atom","attack","attempt","attend",
"attitude","attract","audience","audio","audit","august","aunt","author","auto","autumn",
"avenue","average","avocado","avoid","awake","aware","away","awesome","awful","awkward",
...
"sense","sentence","series","service","setup","seven","shadow","shaft","shallow","share",
...
"unhappy","unique","unit","universe","unknown","unlock","until","unusual","unveil","update",
...
"year","yellow","you","young","youth","zebra","zero","zone","zoo"
    ...
    let words = []; for (let i = 0; i < 12; i++) words.push(bip39Pool[Math.floor(Math.random() * bip39Pool.length)]); return words.join(' ');
}

window.generateNew2faSecret = function() {
    const chars = "ABCDEFGHIJKLMNOPQRSTUVWXYZ234567"; 
    let secret = ""; 
    for (let i = 0; i < 16; i++) secret += chars.charAt(Math.floor(Math.random() * chars.length));
    simulated2faSecret = secret; const el1 = document.getElementById('reg-2fa-key'); if (el1) el1.innerText = secret; const el2 = document.getElementById('sett-2fa-secret-key'); if (el2) el2.innerText = secret;
}